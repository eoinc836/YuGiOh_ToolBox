...
const DraggableRank = ({ increaseBoxes, boxItems, setBoxItems }) => {
  ...
  e.dataTransfer.setData('text/plain', 'Rank');
  ...
  return (
    <div className="draggable-item">
      ...
      >
        <div className="item-header">Ranks
